                                        ...
                                        [
                                            {
                                                stack: [
                                                    ...
                                                    ...(data.client.taxId ? [{ text: `PIB: ${data.client.taxId}`, margin: [0, 2, 0, 0] as [number, number, number, number] }] : [] as any),
                                                    ...(data.client.registrationNumber ? [{ text: `MB: ${data.client.registrationNumber}`, margin: [0, 2, 0, 0] as [number, number, number, number] }] : [] as any),
                                                ],
                                                margin: [8, 8, 8, 8],
                                            },
                                        ],
                                        ...
                                        [
                                            {
                                                stack: [
                                                    ...
                                                    ...(data.bankAccount.swiftCode ? [{ text: `SWIFT: ${data.bankAccount.swiftCode}`, margin: [0, 1, 0, 0] as [number, number, number, number] }] : [] as any),
                                                    ...(data.bankAccount.iban ? [{ text: `IBAN: ${data.bankAccount.iban}`, margin: [0, 1, 0, 0] as [number, number, number, number] }] : [] as any),
